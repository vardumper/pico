...
import {
  compile
} from "./chunk-4D5JAY4J.js";
import "./chunk-HJR7EPNM.js";
import "./chunk-XKWPYUXN.js";
import {
  __commonJS,
  __toESM
} from "./chunk-R3UAGPYA.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-BOXDCTUS.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-246GAGVH.js")).default;
  return {
