...
import {
  versions_default
} from "./chunk-76H2FOTT.js";
import {
  require_picomatch
} from "./chunk-FKMNN3OL.js";
import {
  logger
} from "./chunk-TTS5PSCO.js";
import {
  any,
  from,
  invariant,
...
import {
  ...
  resolvePackageDir,
  safeResolveModule
} from "./chunk-BA3X633S.js";
import {
  join,
  parse,
  resolve
} from "./chunk-F5VMXQ7P.js";
import {
  glob,
  globSync
} from "./chunk-CUZWEO26.js";
import {
  slash
} from "./chunk-JDB4KUMR.js";
import {
  require_dist
} from "./chunk-AZRKJMZH.js";
import {
  require_picocolors
} from "./chunk-5GBQQXLQ.js";
import {
  __commonJS,
  __esm,
  __export,
...
async function loadEnvs(options = {}) {
  let { getEnvironment } = await import("./lib-QI7NOQWR.js"), defaultNodeEnv = options.production ? "production" : "development", baseEnv = {
...
async function scanAndTransformFiles({
  ...
  let globby = (await import("./globby-5QHUP2MM.js")).globby, sourceFiles = await globby([glob2], {
    ...commonGlobOptions(""),
    ignore: ["**/node_modules/**"],
    dot: !0,
    cwd: getProjectRoot(),
...
var transformImportFiles = async (files, renamedImports, dryRun) => {
  let errors = [], { default: pLimit } = await import("./p-limit-LHZEU7FJ.js"), limit = pLimit(10);
  return await Promise.all(
    files.map(
      (file) => limit(async () => {
        try {
